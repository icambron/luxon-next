...
test("toFormat('D') returns a short date representation", () => {
  expect(toFormat(dt, "D")).toBe("5/25/82");
...
test("toFormat('ttt') returns a medium time representation", () => {
  ...
  expect(toFormat(dt, "ttt", { locale: "fr" })).toBe("09:23:54 UTC");
...
test("toFormat('f') returns a short date/time representation without seconds", () => {
  expect(toFormat(dt, "f")).toBe("5/25/82, 9:23 AM");
  expect(toFormat(setGregorian(dt, { hour: 13 }), "f")).toBe("5/25/82, 1:23 PM");
  expect(toFormat(dt, "f", { locale: "fr" })).toBe("25/05/1982 09:23");
  expect(toFormat(setGregorian(dt, { hour: 13 }), "f", "fr")).toBe("25/05/1982 13:23");
});
...
test("toFormat('fff') returns a medium date/time representation without seconds", () => {
  expect(toFormat(ny, "fff")).toBe("May 25, 1982 at 9:23:54 AM EDT");
  expect(toFormat(setGregorian(ny, { hour: 13 }), "fff")).toBe("May 25, 1982 at 1:23:54 PM EDT");
  expect(toFormat(setGregorian(ny, { month: 8 }), "fff")).toBe("August 25, 1982 at 9:23:54 AM EDT");
  expect(toFormat(ny, "fff", { locale: "fr" })).toBe("25 mai 1982 à 09:23:54 UTC−4");
  expect(toFormat(setGregorian(ny, { month: 2 }), "fff", { locale: "fr" })).toBe("25 février 1982 à 09:23:54 UTC−5");
  expect(toFormat(setGregorian(ny, { hour: 13 }), "fff", { locale: "fr" })).toBe("25 mai 1982 à 13:23:54 UTC−4");
});
...
test("toFormat('ffff') returns a long date/time representation without seconds", () => {
  ...
  expect(toFormat(ny, "ffff", { locale: "fr" })).toBe("mardi 25 mai 1982 à 09:23:54 heure d’été de l’Est");
