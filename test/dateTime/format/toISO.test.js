import { fromGregorian, fromMillis, setTime, toISO, toISO, toFixedOffset, setZone, setGregorian } from "../../../src/luxon";
...
test("toISO() handles big years", () => {
  expect(toISO(setGregorian(dt, { year: 12345 }))).toBe("+012345-05-25T09:23:54.123Z");
});
