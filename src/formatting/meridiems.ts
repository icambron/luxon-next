...
export const formatMeridiem = (firstArg?: FormatFirstArg<MeridiemFormatOpts>, secondArg?: FormatSecondArg<MeridiemFormatOpts>): ((date: Date, zone: Zone) => string) => {
...
export const formatMeridiemsMemo = (formatOpts: MeridiemFormatOpts): ((jsDate: Date, zone: Zone) => string) =>
  (d, zone) => {
