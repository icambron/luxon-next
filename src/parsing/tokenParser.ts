...
//
// // todo - can't depend on this from here. Refactor
// import { listMonths, listWeekdays } from "../dateTime/format";
//
//
// // TYPES
// interface TokenParsingBlock<T> {
//   regex: RegExp;
//   deser: (input: Array<string>) => T;
//   groups?: number;
//   literal?: boolean;
//   token: string;
// }
...
// const digitRegex = (numberingSystem: string, append = ""): RegExp => {
//   const latnRegex = "\\d"
...
// // PARSERS
//
// const intUnit = (regex: RegExp, post: ((i: number) => number) = (i: number) => i): TokenParsingBlock<number> => ({
//   regex,
//   deser: ([s]) => post(parseDigits(s))
// })
//
// const oneOf = (strings: Array<string>, startIndex: number): TokenParsingBlock<number> | null => {
//   if (strings === null) {
//     return null;
//   } else {
//     return {
...
// };
//
// const offset = (regex: RegExp, groups: number): TokenParsingBlock<number> => ({
//   regex,
//   deser: ([, h, m]) => signedOffset(h, m),
//   groups
// });
//
// const literal = (t: ParsedToken): TokenParsingBlock<string> => ({ regex: RegExp(escapeToken(t.val)), deser: ([s]) => s, literal: true });
//
// const simple = (regex: RegExp): TokenParsingBlock<string> => ({ regex, deser: ([s]) => s });
//
// function unitForToken(token: ParsedToken, loc: string, numberingSystem: string) {
...
//   const unitate = (t: ParsedToken): TokenParsingBlock<any> | null => {
//     if (token.literal) {
//       return literal(t);
//     }
//     switch (t.val) {
